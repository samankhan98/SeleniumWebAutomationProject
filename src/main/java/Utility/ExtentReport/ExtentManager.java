...
public class ExtentManager {
    ...
    public static ExtentReports createInstance() {
        ...
        extent.setSystemInfo("OS", "Android 11");
        extent.setSystemInfo("Testing Platform", "Mobile Automation");
        extent.setSystemInfo("Team", "Quality Assurance Engineer");
        extent.setSystemInfo("QAE Name", "Saman Khan");
        return extent;
    }
